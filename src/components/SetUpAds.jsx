            ...
            <div className='h-full'>
                ...
                <div className='h-full flex justify-center items-center flex-wrap sm:flex-nowrap gap-4'>
                    <div className='flex flex-col gap-2 sm:basis-1/2'>
                        <button className= 'text-[14px] font-semibold w-full flex justify-start items-center  border-2 border-[#747677] p-1 sm:p-2 rounded-lg gap-2 bg-[#f2f2f7c0]'><Image src={IMG1} /> Brand awareness and reach </button>
