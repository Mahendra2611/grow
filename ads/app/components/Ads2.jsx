  ...
  return (
    <>
      <div className="md:w-full flex ss:w-full">
        {" "}
        <button className=" flex bg-white rounded-l-md  p-3 text-xs font-Jost font-light border-solid border border-gray-300">
          <div className="mr-2">
            <svg
              width="13"
              height="15"
        ...
        <div className="flex bg-white rounded-r-md border border-gray-300 w-full  items-center">
          <button className=" ml-3 text-xs font-Jost font-light border-solid border-2 border-gray-200 rounded-xl bg-slate-50 pl-1.5 pr-1.5 py-0.5">
            Status: Active
          </button>
        </div>
      </div>
      <div className="bg-white py-3  border-solid border border-b-0 border-gray-300 mt-4 flex justify-between items-center md:w-full px-3 rounded-t-md ss:w-full">
        ...
        <button className="bg-blue-500 rounded-xl text-white flex justify-center items-center gap-3 text-xs  p-1.5 px-3 sm:p-2 sm:pl-6 sm:pr-9">
          {" "}
          <svg
            width="11"
            height="11"
