        ...
        <section className="flex gap-5">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[11px] font-semibold">
              Style with Our Latest Watch Collection
            </p>
          </div>
          <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col justify-between gap-2">
            ...
            <div className="flex gap-4">
              <h1 className="flex flex-col gap-2">
                ...
                <span className="text-[12px] font-semibold">50,000</span>
              </h1>
              <h1 className="flex flex-col gap-2">
          ...
          <div className="flex flex-col justify-between gap-2">
            ...
            <div className="flex gap-4">
              <h1 className="flex flex-col gap-2">
                ...
                <span className="text-[12px] font-semibold">05-10-2024</span>
              </h1>
              <h1 className="flex flex-col gap-2">
                <span className="text-[12px] font-semibold">End Date</span>
                <span className="text-[12px] font-semibold">10-05-2024</span>
              </h1>
            </div>
          </div>
        </section>
