    ...
    <div className="h-full p-2 flex flex-col gap-5 ">
      <form className="flex flex-col gap-5 ">
        <div className="flex flex-col gap-2 ">
          <label for="community" className="text-[16px] font-semibold">
        ...
        <div className="flex flex-col gap-2">
          <label for="ad-name" className="text-[16px] font-semibold">
      ...
      <div className="flex flex-col gap-4">
        ...
        <textarea
          className="rounded-lg w-full min-h-[100px] outline-none p-2 border-2 border-[#F2F2F7]"
      ...
      <div className="flex justify-between">
        <div className="basis-1/2 flex flex-col gap-4  ">
          ...
          <select
            id="community"
            className="rounded-lg p-2 place-self-stretch border-2 border-[#F2F2F7]"
          >
            <option
              value={"clothing Girlz"}
              className=" text-[12px] place-self-stretch sm:text-[16px]"
            >
              Select ...
            </option>
          </select>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="relative">
          ...
          <label
            htmlFor="ad-file"
            className="flex items-center justify-center rounded-lg w-full p-2 border-2 border-[#F2F2F7] cursor-pointer"
          >
            <svg
