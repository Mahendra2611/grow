        ...
        <>
            <div className="  flex justify-between mb-3 w-3/4 ss:w-full items-center gap-20">
                ...
                <div className="flex items-center gap-4">
                    <div><button className="font-Jost border-solid border-2 border-gray-300
 text-xs p-2 bg-white font-light rounded-md flex gap-1.5 focus:bg-neutral-200 ss:w-full"><svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
